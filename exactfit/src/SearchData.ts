...
export const searchData = [
  ...
  { keyword: "ac coil servicing", label: "AC Coil Servicing", path: "/allservices#ac-coil-servicing" },
  { keyword: "ac deep water cleaning", label: "AC Deep Water Cleaning", path: "/allservices#ac-deep-water-cleaning" },
  { keyword: "ac spare parts replacement", label: "AC Spare Parts Replacement", path: "/allservices#ac-spare-parts-replacement" },
  { keyword: "wiring repair", label: "Wiring Repair", path: "/allservices#wiring-repair" },
  { keyword: "light installation", label: "Light Installation", path: "/allservices#light-installation" },
  { keyword: "home cleaning", label: "Home Cleaning", path: "/allservices#home-cleaning" },
  { keyword: "office cleaning", label: "Office Cleaning", path: "/allservices#office-cleaning" },
  { keyword: "pipe repair", label: "Pipe Repair", path: "/allservices#pipe-repair" },
